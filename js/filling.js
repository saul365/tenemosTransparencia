...
if(ammount/3030<1){
  sec.innerHTML='Gracias por donal al Teletón, has contribuido a:  '+Math.round((ammount/101)*100)/100+' dias de rehabilitación para un niño.';
}
  ...
  sec.innerHTML='Gracias por donar al Teletón, has contribuido a: ' +Math.round((ammount/36360)*100)/100+' año(s) de rehabilitación para un niño.';
}
